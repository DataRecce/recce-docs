...
1. The impact radius for this model will be displayed.
    ...
    ![Impact radius for a single model displayed on screen](../assets/images/what-you-can-explore/impact-radius-single-2.png){: .shadow}

1. To exit impact radius view, click the close button in the upper-left corner.
    
    ![Close button for exiting single model impact radius view](../assets/images/what-you-can-explore/impact-radius-single-3.png){: .shadow}
