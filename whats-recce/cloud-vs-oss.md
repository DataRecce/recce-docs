...
The agent works with your CLI using [Recce MCP](../setup-guides/mcp-server.md). MCP (Model Context Protocol) is an open standard that lets AI tools call Recce directly. With it, the agent can:
...
- [Recce MCP](../setup-guides/mcp-server.md) for AI-assisted validation with Claude, Cursor, and other AI clients
...
- **Cloud:** [Start Free with Cloud](../getting-started/start-free-with-cloud.md)
- **OSS:** [OSS Setup](../getting-started/oss-setup.md)

## Next Steps

- [Data Developer Workflow](../using-recce/data-developer.md): Using Recce throughout development
- [Recce MCP Server](../setup-guides/mcp-server.md): AI-assisted validation with Claude, Cursor, Windsurf
- [Recce Claude Plugin](../setup-guides/claude-plugin.md): Guided setup for Claude Code users
