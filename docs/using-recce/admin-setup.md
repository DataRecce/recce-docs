...
![Recce Cloud Organization Settings page showing organization name and members section](../assets/images/using-recce/recce-cloud-org-setting-fs8.png){: .shadow}
...
![Invite Members dialog with email input field and role selection](../assets/images/using-recce/recce-cloud-org-invitation-fs8.png){: .shadow}
...
![Recce Cloud home page showing pending invitation notification modal](../assets/images/using-recce/recce-cloud-org-pending-invitation-home-fs8.png){: .shadow}
