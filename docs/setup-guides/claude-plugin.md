...
!!! note
    If you use Cursor, Windsurf, or another AI agent, see the [MCP Server page](mcp-server.md) for direct configuration instructions.
...
The plugin is specific to Claude Code. For Cursor and Windsurf, configure Recce using the [MCP server](mcp-server.md) directly.
