...
After running any diff, you can rerun, export, or download the results.

- **Rerun** - Refresh after model changes
- **Export** - Copy as image, text, or CSV for PR comments and Slack
- **Download** - Save as CSV, TSV, or Excel for offline analysis

<figure markdown>
  ![Diff result options](../assets/images/what-you-can-explore/diff-result-options.png){: .shadow}
  <figcaption>Result options: rerun, export, and download</figcaption>
</figure>
...
<figure markdown>
  ![Row Count Diff - Single model](../assets/images/what-you-can-explore/row-count-diff-single.gif){: .shadow}
...
<figure markdown>
  ![Profile Diff](../assets/images/what-you-can-explore/profile-diff.png)
...
<figure markdown>
  ![Value Diff](../assets/images/what-you-can-explore/value-diff.png)
...
![Value Diff Detail](../assets/images/what-you-can-explore/value-diff-detail.gif){: .shadow}
...
<figure markdown>
  ![Top-K Diff](../assets/images/what-you-can-explore/top-k-diff.gif){: .shadow}
...
<figure markdown>
  ![Top-K Diff Result](../assets/images/what-you-can-explore/top-k-diff.png)
...
<figure markdown>
  ![Histogram Diff](../assets/images/what-you-can-explore/histogram-diff.gif){: .shadow}
  <figcaption>Generate a Histogram Diff from column options</figcaption>
</figure>

<figure markdown>
  ![Histogram Diff Result](../assets/images/what-you-can-explore/histogram-diff.png)
...
<figure markdown>
  ![Query Diff](../assets/images/what-you-can-explore/query-diff.png)
...
<figure markdown>
  ![Query Diff Result](../assets/images/what-you-can-explore/query-diff.gif){: .shadow}
...
- [Validation Techniques](../using-recce/data-developer.md#validation-techniques) - How to use data diffing in your workflow
- [Lineage Diff](lineage-diff.md) - Visualize change impact
- [Checklist](../collaboration/checklist.md) - Save validation results
