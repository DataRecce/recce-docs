...
<figure markdown>
  ![Expanded full-screen view of code changes](../assets/images/what-you-can-explore/full-view-code-of-model.png){: .shadow}
...
- Add your findings to the [collaboration checklist](../collaboration/checklist.md) for team review
